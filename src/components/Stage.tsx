...
export function Stage({ project, peaks, clock, fontBlob, onError }: { project: Project; peaks: number[]; clock: PlaybackClock; fontBlob: Blob | null; onError: (s: string) => void }) {
