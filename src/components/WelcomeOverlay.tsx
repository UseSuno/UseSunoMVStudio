import { AudioLines, FileAudio, FolderOpen, Play } from 'lucide-react';
import { useEffect, useRef } from 'react';
import { useTranslation } from 'react-i18next';
import { LanguagePicker } from './LanguagePicker';
export function WelcomeOverlay({ chooseAudio, demo, openProject, close }: { chooseAudio: () => void; demo: () => void; openProject: () => void; close?: () => void }) {
